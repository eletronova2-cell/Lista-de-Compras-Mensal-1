...
function TelaHistorico({ historico, onVoltar }) {
        ...
        {aba === "lista" && (
          <div style={{ animation:"fadeIn 0.3s ease" }}>
            {[...historico].reverse().map((r,i) => {
              ...
              const pos = eco >= 0;
              return (
                <div key={r.id} style={{ background:"rgba(255,255,255,0.04)", border:`1px solid ${pos?"rgba(16,185,129,0.15)":"rgba(239,68,68,0.15)"}`, borderRadius:14, padding:"14px 18px", marginBottom:10, display:"flex", justifyContent:"space-between", alignItems:"center", animation:`fadeIn ${0.1+i*0.04}s ease` }}>
                  <div>
...
export default function App() {
  ...
  if(tela==="historico")   return <TelaHistorico         historico={historico} onVoltar={voltarHome} />;
}
